...
YOUTUBE_API_KEY_4 = config('YOUTUBE_API_KEY_4')
# DeepL APIキーの設定
DEEPL_API_KEY = config('DEEPL_API_KEY')

# ChatGPT APIキーの設定
CHATGPT_API_KEY = config('CHATGPT_API_KEY')
CHATGPT_API_KEY_1 = config('CHATGPT_API_KEY_1')
CHATGPT_API_KEY_2 = config('CHATGPT_API_KEY_2')

# テスト用動画ID
TEST_YOUTUBE_VIDEO_ID = config('TEST_YOUTUBE_VIDEO_ID')

# テスト用チャンネルID
TEST_YOUTUBE_CHANNEL_ID = config('TEST_YOUTUBE_CHANNEL_ID')
