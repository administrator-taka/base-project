...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.AddField(
            ...
            field=models.CharField(choices=[('ja', 'JAPANESE'), ('en', 'ENGLISH'), ('ko', 'KOREAN'), ('zh', 'CHINESE'),
                                            ('id', 'INDONESIAN')], null=True, verbose_name='デフォルトのテキスト言語コード'),
        ),
        migrations.AddField(
            model_name='videodetail',
            name='description',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('channel',
                 models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='localized_channels',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('description', models.TextField(verbose_name='チャンネルの説明')),
                ('video',
                 models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='localized_videos',
                                   to='myapp.videodetail', verbose_name='動画ID')),
            ],
        ),
    ]
