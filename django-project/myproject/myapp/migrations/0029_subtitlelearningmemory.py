        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('learning_status', models.CharField(
                    choices=[(0, 'NOT_CHECKED'), (1, 'NOT_UNDERSTOOD'), (2, 'ONE_WORD_UNKNOWN'),
                             (3, 'FULLY_UNDERSTOOD')], verbose_name='言語コード')),
                ('last_updated', models.DateTimeField(null=True, verbose_name='最終更新日時')),
                ('subtitle_translation_text_id', models.ForeignKey(db_column='subtitle_translation_text_id',
                                                                   on_delete=django.db.models.deletion.CASCADE,
                                                                   to='myapp.subtitletranslation',
