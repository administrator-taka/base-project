# Generated by Django 5.0.4 on 2024-05-31 05:28
...
class Migration(migrations.Migration):
    dependencies = [
        ('myapp', '0031_remove_subtitlelearningmemory_id_and_more'),
    ]
    ...
    operations = [
        migrations.AlterField(
            ...
            field=models.CharField(choices=[('ja', 'JAPANESE'), ('en', 'ENGLISH'), ('ko', 'KOREAN'), ('zh', 'CHINESE'),
                                            ...
                                            ('vi', 'VIETNAMESE'), ('zh-Hans', 'CHINESE_SIMPLIFIED'),
        ...
        migrations.AlterField(
            ...
            field=django.contrib.postgres.fields.ArrayField(base_field=models.CharField(
                choices=[('ja', 'JAPANESE'), ('en', 'ENGLISH'), ('ko', 'KOREAN'), ('zh', 'CHINESE'),
                         ...
                         ('zh-Hans', 'CHINESE_SIMPLIFIED'), ('zh-HK', 'CHINESE_HONGKONG'),
